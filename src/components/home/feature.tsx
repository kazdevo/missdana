        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/missdana/images/home-feature.png" width={650} height={678} alt="Feature img" quality={100} />
              <Box
                sx={{
                  position: 'absolute',
                  top: -36,
              ...
              >
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <BorderLinearProgress variant="determinate" color="inherit" value={75} order={5} />
                </Box>
                <Box sx={{ mb: 2 }}>
                  <Typography variant="subtitle1" color="text.secondary">
                    Reading
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Уақытыңды үнемде</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Бізге беретін кейбір артықшылықтарыңызбен өз қалауыңыз бойынша оқу тәсілін орнатыңыз, осылайша біз беретін
              сабақтардан ләззат алыңыз.
            </Typography>
