...
export const socialLinks: SocialLink[] = [
  {
    ...
    icon: 'https://kazdevo.github.io/missdana/images/icons/instagram.svg',
  },
  {
    name: 'YouTube',
    link: 'https://www.instagram.com/miss_bakhytova/',
    icon: 'https://kazdevo.github.io/missdana/images/icons/youtube.svg',
  },
  {
    name: 'Twitter',
    link: 'https://www.instagram.com/miss_bakhytova/',
    icon: 'https://kazdevo.github.io/missdana/images/icons/twitter.svg',
  },
  {
    name: 'Dribbble',
    link: 'https://dribbble.com/shots/18114471-Coursespace-Online-Course-Landing-Paghttps://www.instagram.com/miss_bakhytova/',
    icon: 'https://kazdevo.github.io/missdana/images/icons/dribbble.svg',
  },
  {
    name: 'Github',
    link: 'https://github.com/hiriski/coursespace-landing-paghttps://www.instagram.com/miss_bakhytova/',
    icon: 'https://kazdevo.github.io/missdana/images/icons/github.svg',
  },
]
